...
public class Locator implements LocationInterface
{
        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    commonObj.put("version", Locator.this.version);
                    commonObj.put("api_key", Locator.this.apiKey);
                    jsonParam.put("common", commonObj);

                    JSObject gsm_cells = (JSObject) Locator.this.result.get("gsm_cells");
                    ...
                    JSObject wifi_networks = (JSObject) Locator.this.result.get("wifi_networks");
